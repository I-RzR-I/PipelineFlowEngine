...
set applicationName=PipelineFlowEngine
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\PipelineFlowEngine\PipelineFlowEngine.csproj')
set testProjectsPath=$('..\src\tests\PipelineInvokeTest\PipelineInvokeTest.csproj')

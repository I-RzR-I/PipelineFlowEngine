...
//  Author           : RzR
//  Created On       : 2025-06-24 17:24
// 
//  Last Modified By : RzR
//  Last Modified On : 2025-07-09 15:42
// ***********************************************************************
//  <copyright file="PersonSetNamePipelineStep.cs" company="RzR SOFT & TECH">
...
{
    public class PersonSetNamePipelineStep : PipeLineFlowStep<PersonDto>
    {
        /// <inheritdoc />
        ...
        {
            //var result = PipeLineStepResult<PersonDto>.Success();
            ...
            catch (Exception e)
            {
                return PipeLineStepResult<PersonDto>.Failure()
                    .SetMessage("Failed set person name")
